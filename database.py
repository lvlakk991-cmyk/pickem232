"""
Async SQLite data-access layer, shared by the bot process and the web API process.
Every function opens its own short-lived connection (fine for this traffic scale).
"""
import datetime as dt
import aiosqlite

from config import DB_PATH, POINTS_WINNER, POINTS_SCORE, POINTS_MVP
...
CREATE TABLE IF NOT EXISTS channels (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    chat_username TEXT NOT NULL,      -- e.g. @es1zeman  (bot must be admin there to verify subscription)
